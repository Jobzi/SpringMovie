<%-- 
    ...
    Created on : Jul 16, 2019, 3:37:44 PM
    Author     : benja
--%>
        ...
        <div class="hero common-hero">
            <div class="container">
                    <div class="row">
                            <div class="col-md-12">
                                    <div class="hero-ct">
                                            <h1>Reporte de Alquiler por Usuario</h1>
                                            <ul class="breadcumb">
                            ...
                            <div class="sidebar">
                                <div class="searh-form">
                                        <h4 class="sb-title"> Pelicula</h4>
                                                <form class="form-style-1 celebrity-form" action="reportealquiler.htm" method="POST">
                                                    <div class="row">
                                                        <div class="col-md-12 form-it">
                                                            <label>Valor</label>
                                                            <input type="text" step="any" name="valor" placeholder="Enter Value">
                                                        </div>
